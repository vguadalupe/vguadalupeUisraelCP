...
import { EventBaseResponse, OrderBy, TypeFilterEvent, UserBaseResponse } from 'src/app/serviceApi/models';
import { EventService } from 'src/app/serviceApi/services';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-records-candidate',
  templateUrl: './records-candidate.component.html',
  styleUrls: ['./records-candidate.component.css','../../../app.component.css']
})
export class RecordsCandidateComponent implements OnInit, PageBase {
  ...
  public userCurrent? : UserBaseResponse;
  ...
  private eventRequest = {
    ...
    OrderBy: OrderBy.Asc,
    Limit: 100,
    TypeFilter: TypeFilterEvent.Candidate,
  };
  loadEvents(): void {
    this.loading = true;
