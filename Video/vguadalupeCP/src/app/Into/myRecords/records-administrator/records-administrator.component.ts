...
@Component({
  selector: 'app-records-administrator',
  templateUrl: './records-administrator.component.html',
  styleUrls: ['./records-administrator.component.css','../../../app.component.css'],
})
export class RecordsAdministratorComponent implements OnInit , PageBase {
  ...
  private eventRequest = {
    ...
    OrderBy: OrderBy.Asc,
    Limit: 100,
    TypeFilter: TypeFilterEvent.Administrator,
  };
  loadEvents(): void {
    this.loading = true;
